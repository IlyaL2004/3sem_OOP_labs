...
int main() {
    ...
    std::time_t time_st = std::time(nullptr);
    std::time_t time_fin = time_st + 30;
    ...
    int num = 0;
    std::thread move_thread([&array, MAX_X, MAX_Y, DISTANCE, &num]() {
            while (!t_move) {
                // move phase
